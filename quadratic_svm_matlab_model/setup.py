...
if __name__ == '__main__':
    setup_dict = {
        'name': 'quadratic_svm_prediction_with_probability-R2024a',
        'version': '24.1',
        'description': 'A Python interface to quadratic_svm_prediction_with_probability',
        'author': 'MathWorks',
        'url': 'https://www.mathworks.com/',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'quadratic_svm_prediction_with_probability'
        ],
        'package_data': {'quadratic_svm_prediction_with_probability': ['*.ctf']}
    }
